...
BUILDTAG=Linux
PV_F=${PV}xp1 # Workaround for that ugly f-revision
...
SRC_URI="http://beta.unity3d.com/download/59c25c92588f/unity-editor-installer-${PV_F}${BUILDTAG}.sh -> ${P}${BUILDTAG}.sh"
